                    ...
                    <div id="main_slider" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <div class="row ">
                                    <div class="col-md-6 taital">
                                        <h1>Carnema<strong class="banner_taital">Sensasi Nonton Aman Di Tengah Pandemi</strong></h1>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="banner-image"><img src="images/dis.png" style="max-width: 100%;"></div>
                                    </div>
                                </div>
                            </div>
